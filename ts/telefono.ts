...
class User implements Smartphone{
    ...
    public getNumeroChimate():number{
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    btnAvvia.addEventListener('click',():void=>{
    ...
    btnRicarica.addEventListener('click', ():void=>{
        if(scelta.value=='1'){
            if(controllo.test(inputRicarica.value) && inputRicarica.value != undefined){
                let ricarica:number=parseInt(inputRicarica.value)
    ...
    btnChiamata.addEventListener('click',():void=>{
        if(scelta.value=='1'){
            if(controllo.test(inputMinChiamata.value) && inputMinChiamata.value != undefined){
            let chiamata:number=parseInt(inputMinChiamata.value)
    ...
    btn404.addEventListener('click',():void=>{
        if(scelta.value=='1'){
    ...
    btnAzzera.addEventListener('click',():void=>{
        if(scelta.value=='1'){
    ...
    btnNumChiamate.addEventListener('click',():void=>{
        if(scelta.value=='1'){
